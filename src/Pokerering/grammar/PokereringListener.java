...
public interface PokereringListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PokereringParser#loopHead}.
	 * @param ctx the parse tree
	 */
	void enterLoopHead(PokereringParser.LoopHeadContext ctx);
	/**
	 * Exit a parse tree produced by {@link PokereringParser#loopHead}.
	 * @param ctx the parse tree
	 */
	void exitLoopHead(PokereringParser.LoopHeadContext ctx);
	/**
	 * Enter a parse tree produced by {@link PokereringParser#loopBody}.
	 * @param ctx the parse tree
	 */
	void enterLoopBody(PokereringParser.LoopBodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link PokereringParser#loopBody}.
	 * @param ctx the parse tree
	 */
	void exitLoopBody(PokereringParser.LoopBodyContext ctx);
	/**
